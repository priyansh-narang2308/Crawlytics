...
const HeroSection = () => {
  ...
  />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center max-w-5xl pt-20">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[11px] font-black uppercase tracking-[0.2em] text-emerald-400/80 mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
          <Sparkles className="size-3" />
          The Future of Web Content Discovery
        </div>

        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 text-left max-w-4xl mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-700">
          {[
            {
